...
<head>
    ...
    <title>Añadir juego – Backlog Games</title>
    ...
    <main class="flex-1 flex items-center justify-center p-10">
        ...
        <div class="w-full max-w-4xl bg-[#1a1f2c]/90 border border-gray-700/60 rounded-2xl shadow-[0_0_25px_rgba(0,0,0,0.4)] backdrop-blur-sm p-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-100 tracking-tight">Añadir juego</h1>
                    <p class="text-gray-500 text-sm mt-1">
                        Introduce la información del nuevo juego que deseas agregar a tu backlog.
                    </p>
                </div>
                <a href="{{ route('games.index') }}"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status"
                                class="w-full rounded-lg bg-[#0f1117] border border-gray-600/40 text-gray-100 px-4 py-2.5
                                       focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/40 transition">
                            <option value="backlog" @selected(old('status') === 'backlog')>Backlog</option>
                            <option value="playing" @selected(old('status') === 'playing')>Playing</option>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4"
                                  class="w-full rounded-lg bg-[#0f1117] border border-gray-600/40 text-gray-100 px-4 py-2.5
                                         focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/40 transition">{{ old('notes') }}</textarea>
                    </div>
                </div>
